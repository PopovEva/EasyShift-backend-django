"""
URL configuration for work_shift_scheduler project.
...
from shifts.views import UserInfoView 
...
urlpatterns = [
    ...
    path('api/user-info/', UserInfoView.as_view(), name='user-info'),  # Эндпоинт для получения информации о пользователе
]
